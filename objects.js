...
//each object represents a product with a name, price, and category
// property. The function should return an object that groups the 
//products by their categories, with the category names as keys
...
function have(category){
const b_arrow=[]
for(i in category){
    const commit=have.sortBy(products=>{
...
//student with a name and an array of scores, write a function 
//that returns a new array containing the names of all students
...
// to the object called age. The age method should return the current
